...
pub use archive::{
    ...
    ExportReport, ExportRequest, ExportResource, MetricBucket, PullOptions, PullPlan, PullReport, PullResource,
    RangeSnapshotFile, StoreAction, MANIFEST_VERSION,
};
pub use client::Client;
pub use config::{
    config_file_path, friendly_config_key, get_config_entry, list_config_entries,
    load_home_config, resolve_config_key, scout_home, set_config_entry, unset_config_entry,
