...
pub use archive::{
    ...
    ExportReport, ExportRequest, ExportResource, MetricBucket, PullOptions, PullPlan, PullRefusal,
    PullReport, PullResource, RangeSnapshotFile, StoreAction, MANIFEST_VERSION,
};
