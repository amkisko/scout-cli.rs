...
The provided `app-misc/scout-cli/scout-cli-0.3.0.ebuild` is a minimal template. Copy it to a local overlay. It may require network access during build to fetch crates. For a fully offline, reproducible build use Option A.
